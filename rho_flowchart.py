...
if __name__ == '__main__':
    ...
    cond1 += 'the direction of interest shall complies with Table 12.3-3.'

    cond2 = 'Structures are regular in plan at all levels provided\n'
    cond2 += 'that the seismic force-resisting systems consist of at\n'
    cond2 += 'least two bays of seismic force-resisting perimeter framing\n'
    cond2 += 'on each side of the structure in each orthogonal direction at\n'
    cond2 += 'each story resisting more than 35% of the base shear. The number\n'
    cond2 += 'of bays for a shear wall shall be calculated as the length of shear\n'
    cond2 += 'wall divided by the story height or two times the length of shear\n'
    cond2 += 'wall divided by the story height, hsx, for light-frame construction.'
    ...
    g.node('Not extreme torsional irregularity', shape = shape, color = color, style = style, fillcolor = fillcolor)
    ...
    g.edge('Rigid diaphragm', 'Not extreme torsional irregularity', splines='false')
    g.edge('Not extreme torsional irregularity', cond1, splines='false')
    ...
    g.edge('Flexible diaphragm', cond2, splines='false')
